...
parser.add_option("--model_path", dest="model_path", help="path to trained model.")
...
if not options.model_path:
	parser.error('TAMIR: Need model path')
	exit(-1)
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
	...
	for key in bboxes:
		...
		for jk in range(new_boxes.shape[0]):
			...
			cv2.rectangle(img,(real_x1, real_y1), (real_x2, real_y2), (int(class_to_color[key][0]), int(class_to_color[key][1]), int(class_to_color[key][2])),thickness=10)
